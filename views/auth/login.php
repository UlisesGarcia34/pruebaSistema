...
<head>
    ...
    <link rel="stylesheet" href="/EstilosLogin/styleslogin.css">
    ...
    <style>
        .modal-dialog {
            max-width: 400px; /* Tamaño reducido del cuadro */
        }
        ...
        .modal-body h3.title img {
            padding-bottom: 0; /* Ajuste del padding del logo */
        }
    </style>
</head>

<body>
    <header class="header" style="background-image: url('img/wallpaperMira.jpg'); background-size: cover; background-position: center;">
            ...
            <div class="col-md-12">
                <div class="modal-box">
                    ...
                    <button type="button" class="btn show-modal" data-bs-toggle="modal" data-bs-target="#myModal" style="background: none; border: none; padding: 0; cursor: pointer;">
                        <img src="/img/ojoAzul.png" width="150" height="150" alt="" class="animate-img">
                    </button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content clearfix">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!--imagen de logotipo Mira en el login-->
                                    <img src="img/miraLogoPNG.png" height="100px" alt="" style="margin-top: -50px;">
